...
public:
  ...
  dynamixel::Result<void, dynamixel::DxlError> setTargetPosition(uint8_t id, double radians);
  dynamixel::Result<void, dynamixel::DxlError> setTargetPosition(
    const std::unordered_map<uint8_t, double> & radians);
  dynamixel::Result<void, dynamixel::DxlError> setTargetPosition(double radians);
  ...
  dynamixel::Result<std::unordered_map<uint8_t, double>, dynamixel::DxlError> readPositions();
  std::unordered_map<uint8_t, double> memPositions() const;

private:
  dynamixel::Motor & servo(uint8_t id);
  dynamixel::Result<void, dynamixel::DxlError> setTargetPositionsLocked(
    const std::unordered_map<uint8_t, double> & radians);
